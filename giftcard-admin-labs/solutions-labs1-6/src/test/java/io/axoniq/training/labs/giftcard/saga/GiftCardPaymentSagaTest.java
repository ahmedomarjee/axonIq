...
public class GiftCardPaymentSagaTest {
    ...
    public void shouldRedeemGiftCardWhenOrderIsPlaced() {
        fixture.givenAggregate("orderId").published(new OrderPlacedEvent("orderId", "cardId", 100))
               .whenAggregate("cardId").publishes(new CardRedeemedEvent("cardId", "orderId", 100))
